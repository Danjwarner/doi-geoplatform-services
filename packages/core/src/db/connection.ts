 ...
 */
export async function testDbConnection(db: ReturnType<typeof getEcsDb>): Promise<boolean> {
  try {
 ...
 * @param db - Drizzle ORM instance
 */
export async function installPostGIS(db: ReturnType<typeof getEcsDb>) {
  try {
